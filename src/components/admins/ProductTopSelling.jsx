...
export default function ProductTopSelling() {
    ...
    const fetchAllProducts = () => {
        setLoading(true);
        axios
            .get('http://localhost:8111/api/v1/categories/products/top-selling')
                    ...
                    <Table sx={{ minWidth: 650 }} size="small">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell>Tên sản phẩm</TableCell><TableCell>Màu</TableCell> {/* Thêm cột màu */}
